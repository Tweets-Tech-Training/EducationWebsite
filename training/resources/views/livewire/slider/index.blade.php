        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0"> السلايدرز </h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('dashboard')}}">الرئيسية</a>
                                </li>
                                <li class="breadcrumb-item active">السلايدرز </li>
                            </ol>
                        </div>
                    </div>
                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 col-12">
                                                                    <div class="form-group">
                                                                        <label for="عنوان السلايدر">عنوان السلايدر</label>
                                                                        <input type="text" wire:model.defer="searchByTitle" id="searchByTitle" class="form-control" placeholder="عنوان السلايدر" name="searchByTitle">
                                                                    </div>
                                                                </div>
                ...
                <div class="table-responsive">
                        ...
                        <div class="top">
                            ...
                            <div class="actions action-btns">
                                ...
                                <div class="dt-buttons btn-group">
                                    <a href="{{route('slider.create')}}"  class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light"><i class="feather icon-plus-circle"></i>
                                         اضافة سلايدر جديد                                 </a>
                    ...
                    @forelse($sliders as $slider)
                        <tr>
                            <td >{{ $slider->id }}</td>
                            <td >{{ $slider->title }}</td>
                            <td ><img src="{{asset('/storage/images/' . $slider->image)}}"  width="50" height="50" class="rounded-circle"  /></td>
                            <td >
                                <a type="button" class="btn btn-icon btn-icon rounded-circle btn-primary mr-1 mb-1 waves-effect waves-light" href="{{route('slider.edit',$slider->id)}}"><i class="feather icon-edit"></i></a>
                                <button type="button" class="btn btn-icon btn-icon rounded-circle btn-danger mr-1 mb-1 waves-effect waves-light" wire:click="delete({{ $slider->id }})"><i class="feather icon-trash"></i></button>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            ...
                            <div  class=" col-10 alert alert-primary alert-dismissible fade show" role="alert">
                                ...
                                <h5 style="display: inline-block; margin-left: 1px">لا يوجد سلايدر...</h5>
                            </div>
