                ...
                <div class="top-bar-start d-flex">
                    ...
                    <div class="clearfix">
                        <ul class="contact">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)" class="text-dark" data-bs-toggle="dropdown"><span> Language <i class="fe fe-chevron-down text-muted"></i></span> </a>
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)" class="text-dark" data-bs-toggle="dropdown"><span>Currency <i class="fe fe-chevron-down text-muted"></i></span></a>
                                <div class="dropdown-menu dropdown-menu-start dropdown-menu-arrow">
                                    <a href="javascript:void(0)" class="dropdown-item" >
                                        USD
                                    </a>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-8 col-12">
                <div class="top-bar-end">
                    <ul class="custom">
                        ...
                        <li>
                            <a href="login.html" class="text-dark"><i class="fe fe-log-in ms-1"></i> <span>Login</span></a>
                        </li>
                        <li class="dropdown">
                            <a href="javascript:void(0)" class="text-dark" data-bs-toggle="dropdown"><i class="fe fe-home ms-1"></i><span> My Dashboard<i class="fe fe-chevron-down text-white me-1"></i></span></a>
                            <div class="dropdown-menu dropdown-menu-start dropdown-menu-arrow">
