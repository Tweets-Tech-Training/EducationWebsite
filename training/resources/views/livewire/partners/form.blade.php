                    ...
                    <ul class="nav nav-tabs mb-3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#" aria-controls="account" role="tab" aria-selected="true">
                                ...
                                @if($partner->id)
                                    <span class="d-none d-sm-block">تعديل الشركاء </span>
                                @else
                                    <span class="d-none d-sm-block"> اضافة شريك جديد  </span>
                                @endif
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                <div class="row">
                                    <div class="col-12 col-sm-8">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" wire:model="partner.title"  name="title"   placeholder="الاسم">
                                                @error('partner.title') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" wire:model="partner.link"  name="link"   placeholder=" رابط الموقع ">
                                                @error('partner.link') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <h4 style="text-align: center">  الشعار   </h4>
                                            ...
                                            <div class="upload-btn">
                                                ...
                                                @else
                                                    ...
                                                    <div style="width: 200px ; height: 200px">
                                                        <img style="border: 3px solid #D3D3D3; border-radius: 15px; width: 100%; height: 100%" src="{{$partner->image?asset('storage/images/'.$partner->image):asset('storage/images/no-image.png')}}">
                                                        <div>
                                                            @error('partner.image') <span class="text-danger" style="font-size: 1rem ;display: block;!important;">{{ $message }}</span> @enderror
                                                        </div>
                                                    </div>
                                                @endif
                                            </div>
                                ...
                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1" >
                                    ...
                                    @endif
                                    <a href="{{route('partners.index')}}"  class="btn btn-outline-danger">الغاء</a>
                                </div>
                        </div>
