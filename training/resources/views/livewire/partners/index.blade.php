                        ...
                        <table class="table data-thumb-view dataTable no-footer dt-checkboxes-select" id="DataTables_Table_0" role="grid">
                            ...
                            @forelse($partners as $partner)
                                <tr>
                                    <td >{{ $partner->id }}</td>
                                    <td >{{ $partner->title }}</td>
                                    <td ><img src="{{asset('/storage/images/' . $partner->image)}}"  width="120" height="60" class="rounded-circle"  /></td>
                                    <td >
                                        ...
                                        <button type="button" wire:click="deleteId({{ $partner->id }})" class="btn btn-icon btn-icon rounded-circle btn-danger mr-1 mb-1 waves-effect waves-light" data-toggle="modal" data-target="#exampleModal"><i class="feather icon-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
                          <x-nodata></x-nodata>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تأكيد الشريك </h5>
