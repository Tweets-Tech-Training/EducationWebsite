...
<!-- Title -->
<title>Edomi - Online Education</title>

<!-- Bootstrap css -->
<link href="{{asset('FrontTheme/assets/plugins/bootstrap/css/bootstrap.rtl.css')}}" rel="stylesheet" />

<!-- Sidemenu Css -->
<link href="{{asset('FrontTheme/assets/css-rtl/sidemenu.css')}}" rel="stylesheet" />

<!-- Dashboard Css -->
<link href="{{asset('FrontTheme/assets/css-rtl/style.css')}}" rel="stylesheet" />
<link href="{{asset('FrontTheme/assets/css-rtl/admin-custom.css')}}" rel="stylesheet" />

<!-- c3.js Charts Plugin -->
<link href="{{ asset('FrontTheme/assets/plugins/charts-c3/c3-chart.css' ) }}" rel="stylesheet" />

<!-- P-scroll bar css-->
<link href="{{asset('FrontTheme/assets/plugins/pscrollbar/pscrollbar.css') }}" rel="stylesheet" />

<!-- Data table css -->
<link href="{{asset('FrontTheme/assets/plugins/datatable/css/dataTables.bootstrap5-rtl.css') }}" rel="stylesheet" />
<link href="{{asset('FrontTheme/assets/plugins/datatable/css/jquery.dataTables.min-rtl.css')}}" rel="stylesheet" />
