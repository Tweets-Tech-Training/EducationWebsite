                        ...
                        <div class="top">
                            <div class="actions action-btns">
                                ...
                                <div class="dt-buttons btn-group">
                                    <a href="{{route('testimonial.create')}}"  class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light"><i class="feather icon-plus-circle"></i>
                                        اضافة رأي  جديد                                 </a>
                            ...
                            @forelse($testimonials as $testimonial)
                                <tr>
                                    ...
                                    <td >
                                        ...
                                        <button type="button" class="btn btn-icon btn-icon rounded-circle btn-danger mr-1 mb-1 waves-effect waves-light" wire:click="delete({{ $testimonial->id }})"><i class="feather icon-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    ...
                                    <div  class=" col-10 alert alert-primary alert-dismissible fade show" role="alert">
                                        ...
                                        <h5 style="display: inline-block; margin-left: 1px">لا يوجد آراء...</h5>
                                    </div>
