...
<!--Owl Carousel js -->
<script src="{{asset('FrontTheme/assets/plugins/owl-carousel/owl.carousel.js')}}"></script>

<!--Horizontal Menu js-->
<script src="{{asset('FrontTheme/assets/plugins/horizontal-menu/horizontal-menu.js')}}"></script>
...
<script src="{{asset('FrontTheme/assets/plugins/counters/numeric-counter.js')}}"></script>

<!--JQuery TouchSwipe js-->
<script src="{{asset('FrontTheme/assets/js/jquery.touchSwipe.min.js')}}"></script>
...
<script src="{{asset('FrontTheme/assets/plugins/jquery.flexdatalist/jquery.flexdatalist.js')}}"></script>
<script src="{{asset('FrontTheme/assets/plugins/jquery.flexdatalist/data-list.js')}}"></script>

<!-- sticky js-->
<script src="{{asset('FrontTheme/assets/js/sticky.js')}}"></script>

<!-- Cookie js -->
<script src="{{asset('FrontTheme/assets/plugins/cookie/jquery.ihavecookies.js')}}"></script>
<script src="{{asset('FrontTheme/assets/plugins/cookie/cookie.js')}}"></script>

<!-- Scripts js-->
<script src="{{asset('FrontTheme/assets/js/owl-carousel-rtl.js')}}"></script>
