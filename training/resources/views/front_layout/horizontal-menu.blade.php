        ...
        <nav class="horizontalMenu clearfix d-md-flex">
            <ul class="horizontalMenu-list">
                ...
                <li aria-haspopup="true"><a href="javascript:void(0)">Blog <span class="fe fe-chevron-down m-0"></span></a>
                    <ul class="sub-menu">
                        <li aria-haspopup="true"><a href="javascript:void(0)">Blog Grid <i class="fa fa-angle-left float-end mt-1 d-none d-lg-block"></i></a>
                            <ul class="sub-menu">
                        ...
                        <li aria-haspopup="true"><a href="javascript:void(0)">Blog List <i class="fa fa-angle-left float-end mt-1 d-none d-lg-block"></i></a>
                            <ul class="sub-menu">
                        ...
                        <li aria-haspopup="true"><a href="javascript:void(0)">Blog Details <i class="fa fa-angle-left float-end mt-1 d-none d-lg-block"></i></a>
                            <ul class="sub-menu">
                ...
                <li aria-haspopup="true"><a href="javascript:void(0)">Custom Pages <span class="fe fe-chevron-down m-0"></span></a>
                    <ul class="sub-menu">
                        ...
                        <li aria-haspopup="true"><a href="javascript:void(0)">Submenu<i class="fa fa-angle-left float-end mt-1 d-none d-lg-block"></i></a>
                            <ul class="sub-menu">
                                <li aria-haspopup="true"><a href="javascript:void(0)">Level-01</a></li>
                                <li aria-haspopup="true"><a href="javascript:void(0)">Level-02<i class="fa fa-angle-left float-end mt-1 d-none d-lg-block"></i></a>
                                    <ul class="sub-menu">
